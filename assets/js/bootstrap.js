...
!function( $ ) {
  ...
  * ======================= */
  ...
  $.fn.popover.defaults = $.extend({} , $.fn.tooltip.defaults, {
    placement: 'right'
  , content: ''
  , template: '<div className="popover"><div className="arrow"></div><div className="popover-inner"><h3 className="popover-title"></h3><div className="popover-content"><p></p></div></div></div>'
  })
